...
urlpatterns = [
    ...
    path('alumin', HodViews.alumni, name="alumni"),
    ...
    path('edit_programme/<str:programme_id>',
         HodViews.edit_programme, name="edit_programme"),
    path('edit_programme_save', HodViews.edit_programme_save,
         name="edit_programme_save"),
    path('edit_course_save', HodViews.edit_course_save, name="edit_course_save"),
    path('edit_student_save', HodViews.edit_student_save, name="edit_student_save"),
    path('all_programmes', HodViews.all_programmes, name="all_programmes"),
    path('academic_sem_selection', HodViews.academic_sem_selection,
         name="academic_sem_selection"),
    path('admin_view_results_of_pupils', HodViews.admin_view_results_of_pupils,
         name="admin_view_results_of_pupils"),
    # staff urls
    ...
    path('bursar_update_fees',BursarViews.bursar_update_fees, name="bursar_update_fees"),
    ...
    path('start_live_classroom', StaffViews.start_live_classroom,
    ...
    #path('instructor_index', StaffViews.instructor_index, name="instructor_index"),
    #url(r'^instructor_index/$', StaffViews.instructor_index, name='instructor_index'),
    re_path(r'^(?P<course_id>[0-9]+)/instructor_detail/$',
            StaffViews.instructor_detail, name='instructor_detail'),
    ...
    re_path(r'^(?P<assignment_id>[0-9]+)/view_feedback/$',
            StaffViews.view_feedback, name='view_feedback'),
